...
public class mm1kqueue {
	...
	public mm1kqueue(double inLam, double inTs, int maxQSize) {
		rnd = new Random();
		currentTime = 0;
		servTime = inTs;
		mu = 1/servTime;
...
//		mm1kqueue c = new mm1kqueue(50,.02, 3);//part a
//		mm1kqueue c = new mm1kqueue(50,.015, 3); //part b
		mm1kqueue c = new mm1kqueue(65,.015, 3); //part c
		double runTime = 100;
		...
		c.eventsQ.push(nextArrival + c.nextTime(c.mu), "death");
